...
public class checkinventory extends AppCompatActivity {
    ...
    private static final String SUPABASE_URL_INVENTORY = "https://lincidhuobbcjwwccsty.supabase.co/rest/v1/Products";
    ...
    private void fetchUsersFromSupabase() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(checkinventory.this, "Ошибка при получении данных", Toast.LENGTH_SHORT).show()
                );
